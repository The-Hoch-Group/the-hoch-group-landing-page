      ...
      <div v-if="modelValue" class="modal-overlay" @click.self="close" role="dialog" aria-modal="true">
        <div class="modal-box">
          ...
          <template v-if="!submitted">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input class="form-input" :class="{ error: errors.name }" v-model="form.name" placeholder="Your full name" type="text" />
                <span v-if="errors.name" class="form-error">{{ errors.name }}</span>
              </div>
              <div class="form-group">
                <label class="form-label">Email Address *</label>
                <input class="form-input" :class="{ error: errors.email }" v-model="form.email" placeholder="you@example.com" type="email" />
            ...
            <div class="form-group">
              ...
              <textarea class="form-textarea" :class="{ error: errors.message }" v-model="form.message" placeholder="Tell us about your project, requirements, or how we can help..." />
          ...
          <div v-else class="success-state">
            ...
            <p class="success-msg">Thank you, {{ firstName }}. A member of the HOCH Group team will be in touch with you shortly.</p>
...
const form = reactive({ name: '', email: '', phone: '', company: '', type: 'General', message: '' })
...
.form-input::placeholder, .form-textarea::placeholder { color: rgba(232,224,204,0.2); }
.form-select option { background: var(--dark); }
.form-textarea { resize: vertical; min-height: 120px; }
.form-input.error, .form-select.error, .form-textarea.error { border-color: #c94c4c; }
